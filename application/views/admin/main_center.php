...
function toggleMenu()
{
  ...
  if (frmBody.cols == "0, 10, *,10")
  {
    frmBody.cols="165, 10, *,10";
    imgArrow.src = "<?=base_url()?>images/admin_barclose.gif";
  }
  else
  {
    frmBody.cols="0, 10, *,10";
...
<table height="100%" cellspacing="0" cellpadding="0" id="tbl">
  <tr><td style="padding-left:1px;"><a href="javascript:toggleMenu();"><img src="<?=base_url()?>images/admin_barclose.gif" width="9" height="60" id="img" border="0"  /></a></td></tr>
</table>
</body></html>